    ...
    <>
      <div
        className={classNames(
          ...
          {
            "relative bg-white": appState.appIsReady,
          }
        )}
      >
        <LWToolBar />
        ...
        {appState.appIsReady && (
          <div
            className={classNames(
              "w-full flex relative lg:border-t-0 lg:rounded-t-none lg:bg-transparent lg:overflow-visible mt-0 lg:mt-7 p-6 lg:p-0 border-t border-primary-150 rounded-t-[32px] bg-white overflow-y-scroll",
              {
